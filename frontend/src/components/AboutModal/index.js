      ...
      >
        ...
        <DialogContent dividers>
          <>
            ...
            <Typography>
              <Link target="_blank" href="https://yourbrand.com">
                {i18n.t("about.aboutauthorsite")}
              </Link>
            </Typography>
            <Typography>
              <Link target="_blank" href="https://github.com/your-org/your-repo">
            ...
            <Typography>
              <Link target="_blank" href="https://github.com/your-org/your-repo/blob/main/LICENSE.md">
